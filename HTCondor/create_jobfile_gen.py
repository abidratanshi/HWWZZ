...
output =    '/ceph/aratanshi/HTCondor/gen/' # output directory of submission files, needs to be different to have unique submission files
outputDir = '/ceph/aratanshi/stage_gen_output/' # output directory of stage samples
localDir =  '/work/aratanshi/HWWZZ/analysis/gen/'
sourceDir = '/work/aratanshi/FCCAnalyses/'
Filename =  'analysis_stage_gen.py'
